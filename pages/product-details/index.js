...
import Img1 from "../../public/assets/homeCatImgs/home-categories1.png";
import Img2 from "../../public/assets/homeCatImgs/home-categories2.svg";
import Img3 from "../../public/assets/homeCatImgs/home-categories3.svg";
import Img4 from "../../public/assets/homeCatImgs/home-categories4.svg";
import Img5 from "../../public/assets/homeCatImgs/home-categories5.svg";
        ...
        >
          ...
          <div className={styles.size_box_wrapper}>
            {[7, 8, 9, 10]?.map((item, index) => {
              return (
                <div key={index} className={styles.size_box}>
                  {item}
                </div>
              );
            })}
          ...
          {/* <div className={styles.offers_wrapper}>
            ...
            <Image src={DeliveryImg} alt="" className={styles.offers_tag_img} />
          </div>
          <div>
          ...
          <div>
            <Row gutter={[32, 32]}>
              {productCardData?.data?.slice(0, 4)?.map((item, index) => {
                return (
                  <Col key={index} xs={24} xl={6} lg={6} md={8} sm={24}>
