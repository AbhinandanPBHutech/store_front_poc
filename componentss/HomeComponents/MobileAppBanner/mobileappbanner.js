...
import Img from "../../../public/assets/mobileAppBanner/mobile-img.png";
...
import QrCodeImg from "../../../public/assets/mobileAppBanner/qr-code.png";
    ...
    <div className={styles.container}>
      <Row>
        ...
        <Col xl={9} lg={9} md={9} sm={24} xs={24}>
          {/* <Image className={styles.mobile_img} src={Img} alt="" /> */}
        </Col>
      </Row>
    </div>
  );
